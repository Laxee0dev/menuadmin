...
TriggerPlayerEvent = function(name, source, r, a, b, c, d) -- Trigger Player Event
    TriggerServerEvent("cAdmin:PlayerEvent", name, source, r, a, b, c, d)
end
...
local SelectedMenu = {
    ["joueur"] = function(menu, curMenu, btnName, self)
        ...
        elseif btnName == "kick" then
            AskEntry(function(msg)
                ...
                TriggerServerEvent("cAdmin:KickPlayer", idPlayer, msg) -- Todo
        ...
        elseif btnName == "ban" then
            AskEntry(function(raison)
                ...
                TriggerServerEvent('cAdmin:Ban', idPlayer, raison, GetPlayerName(PlayerId())) -- Todo
    ...
    ["joueur ban"] = function(menu, curMenu, btnName, self)
        ...
        elseif btnName == "revoquer le bannissement" then
            TriggerServerEvent("cAdmin:DeleteBan", Admin.ListBanned.id, Admin.ListBanned.SteamName) -- Todo
        end
    end,
    ...
    ["monde"] = function(datas, um, name, s, h)
        ...
        elseif name == "chercher un id hors ligne" then
            AskEntry(function(names)
                ...
                TriggerServerEvent('cAdmin:SearchBanOffline', names) -- Todo
        ...
        elseif name == "bannir hors ligne" then
            AskEntry(function(names)
                ...
                AskEntry(function(raison)
                    ...
                    TriggerServerEvent('cAdmin:BanPlayerOffline', names, raison, GetPlayerName(PlayerId())) -- Todo
                end, "Raison", 255)
